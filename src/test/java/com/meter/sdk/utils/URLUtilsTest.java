...
public class URLUtilsTest {
    ...
    public void testUrlComposite() {
        ...
        Assert.assertEquals("Composite path url is failed.", "http://thor-node.com/accounts/0x3213132321421423143",
                compositedURL);
    }
    ...
    public void testUrlCompositeQueryString() {
        ...
        Assert.assertEquals("Composite path url is failed.",
                "http://thor-node.com/accounts/0x3213132321421423143?name=foo&description=hello%20world&age=21",
                compositedURL);
