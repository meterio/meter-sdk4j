...
public class WalletUtilsTest extends BaseTest {
	...
	public void testCreateWallet() {
		...
		logger.info("privKey:" + BytesUtils.toHexString(walletInfo.getKeyPair().getRawPrivateKey(),
				Prefix.ZeroLowerX));
		logger.info("pubKey:" + BytesUtils.toHexString(walletInfo.getKeyPair().getRawPublicKey(false),
				Prefix.ZeroLowerX));
		logger.info("address:" + walletInfo.getKeyPair().getHexAddress());
		/**
		 *
		 * 2018-06-29 12:41:43.862 [main] INFO com.meter.sdk.utils.WalletUtilsTest -
		 ...
		 * 2018-06-29 12:41:43.864 [main] INFO com.meter.sdk.utils.WalletUtilsTest -
		 * privKey:0x21cff7040a640d856a8e6ea201baf33afdbdba47f03ed603e32d025d236cc4df
		 * 2018-06-29 12:41:43.865 [main] INFO com.meter.sdk.utils.WalletUtilsTest -
		 ...
		 * 2018-06-29 12:41:43.866 [main] INFO com.meter.sdk.utils.WalletUtilsTest -
	...
	public void testloadWallet() {
		...
		logger.info("pubKey:" + BytesUtils.toHexString(walletInfo.getKeyPair().getRawPublicKey(false),
				Prefix.ZeroLowerX));
		logger.info("address:" + walletInfo.getKeyPair().getHexAddress());
		Assert.assertEquals("0x866a849122133888214ac9fc59550077adf14975",
