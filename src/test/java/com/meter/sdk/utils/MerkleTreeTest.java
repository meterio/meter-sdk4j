...
import com.meter.sdk.utils.merkle.IBinaryTreeNode;
import com.meter.sdk.utils.merkle.MerkleLeaf;
import com.meter.sdk.utils.merkle.MerkleTree;
...
public class MerkleTreeTest {
	...
	public void testMerkleTree() {
		...
		while (tempNode != null) {
			logger.info("current value: {}, type:{}",
					BytesUtils.toHexString(tempNode.getValue(), Prefix.ZeroLowerX),
