...
public class RawTransactionFactory {
	 ...
	 * 
	 * @param chainTag
	 *            byte the last byte of genesis block id.
	 * @param blockRef
	 *            byte[] the first 8 bytes of the block id. Get from
	 *            {@link com.meter.thorclient.core.model.clients.BlockRef} toByteArray().
	 * @param expiration
	 *            the expiration of block size from best block to block reference.
	 * @param gasInt
	 *            must >= 21000.
	 * @param gasPriceCoef
	 *            must > 0
	 * @param nonce
	 *            eight bytes array, random by cryptography method.
	 * @param toClauses
	 *            to clauses array.
