...
import com.meter.thorclient.utils.crypto.ECKey;
import com.meter.thorclient.utils.crypto.ExtendedKey;
import com.meter.thorclient.utils.crypto.Key;
import com.meter.thorclient.utils.crypto.ValidationException;
...
public final class X509CertificateUtils {
	 ...
	 * @return
	 */
	public static boolean verifyCertificateSignature(X509Certificate certificate, byte[] rootPubKey, byte[] chaincode) {
		...
		com.meter.thorclient.utils.crypto.ECPublicKey ecPublicKey = new com.meter.thorclient.utils.crypto.ECPublicKey(
				rootPubKey);
