...
import com.meter.sdk.utils.crypto.*;
...
public class BlockchainUtils {
	 ...
	 * 
	 * @param address
	 *                address hex string start with "0x", "VX" or without prefix
	 *                string.
	 * @return boolean value.
	 */
	...
	public static String generateTransactionId(byte[] signingHash, Address signer) {
		...
		System.arraycopy(signer.toByteArray(), 0, concatenatedBytes, signingHash.length,
				signer.toByteArray().length);
