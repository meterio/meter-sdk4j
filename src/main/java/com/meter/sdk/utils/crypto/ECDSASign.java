package com.meter.sdk.utils.crypto;
...
import static com.meter.sdk.utils.Assertions.verifyPrecondition;
...
public class ECDSASign {
    ...
    /**
     * Sign the message with {@link ECKeyPair}. Only recovery id 0 or 1 is accepted,
     * otherwise the method will continue to retry to sign til get recovery id is 0
     * or 1.
     * 
     * @param message    message to be signed.
     * @param keyPair    {@link ECKeyPair}
     * @param needToHash set if the message to be hashed before signing. If it is
     *                   true, hashed first,then sign. If it is false, signed
     *                   directly.
    ...
    public static ECDSASign.SignatureData signMessage(byte[] message, ECKeyPair keyPair, boolean needToHash)
        ...
        if (recId == 2 || recId == 3) {
            throw new SignException("Recovery is not valid for meter MainNet.");
        }
    ...
    public static class SignatureData {
        ...
        /**
         * Convert to bytes array. r bytes array append s bytes array, and then append v
         * byte.
         * 
