...
public abstract class ECKey implements Key {
    ...
    public static java.security.spec.ECPoint decodeECPoint(byte[] publicKey) {
        ...
        return new java.security.spec.ECPoint(bcECPoint.getXCoord().toBigInteger(),
                bcECPoint.getYCoord().toBigInteger());
     ...
     * @param signature the signature bytes array |32 bytes r value| 32 bytes s
     *                  value|
