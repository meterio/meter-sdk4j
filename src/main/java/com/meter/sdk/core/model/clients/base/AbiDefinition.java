...
public class AbiDefinition {
     ...
     * <p>
     * this does not factor into the <code>#hashCode()</code> or
     * <code>#equals()</code> logic
     * since multiple functions with the same signature that only differ in
     * mutability are not
     * allowed in Solidity.
     * </p>
     * <p>
    ...
    public String getHexMethodCodeNoPefix() {
        byte[] hashCode = getBytesMethodHashed();
