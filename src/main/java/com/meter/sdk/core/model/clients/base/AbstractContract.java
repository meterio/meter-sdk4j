...
import com.meter.sdk.utils.ContractParamEncoder;
...
public class AbstractContract {
	...
	public AbiDefinition findAbiDefinition(String name, String type, List<String> inputTypes) {
		...
		throw new IllegalArgumentException(
				this.getClass().getSimpleName() + " doesn't has abi define of name:" + name);
	}
	 ...
	 */
	public static ToClause buildToClause(Address toAddress, AbiDefinition abiDefinition, int token,
			Object... hexArguments) {
	...
	protected static String buildData(AbiDefinition abiDefinition, Object... params) {
		...
		for (index = 0; index < params.length; index++) {
			...
			if (isDynamic) {
				String encodedDataOffset = ContractParamEncoder.encodeNumeric(
						BigInteger.valueOf(dynamicDataOffset),
						true);
