...
/**
 * Block revision object, it is constructed by block number, block hex string Id
 * or "best" refer to {@link #BEST}.
 */
public class Revision {
     ...
     * 
     * @param blockId block id hex string start with prefix "0x" or "best" string
     *                ignored case.
     * @return {@link Revision}
     */
