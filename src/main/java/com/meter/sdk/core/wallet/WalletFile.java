package com.meter.sdk.core.wallet;
...
public class WalletFile {
    ...
    /**
     * The keystore cryptography parts.
     */
    public static class Crypto {
        ...
        // To support my Ether Wallet keys uncomment this annotation & comment out the
        // above
    ...
    // If we need to work with MyEtherWallet we'll need to use this deserializer,
    // see the
    ...
    static class KdfParamsDeserialiser extends JsonDeserializer<KdfParams> {
        ...
        public WalletFile.KdfParams deserialize(
            ...
            // it would be preferable to detect the class to use based on the kdf parameter
            // in the
