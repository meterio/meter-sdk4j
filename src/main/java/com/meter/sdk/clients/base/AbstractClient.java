...
public abstract class AbstractClient {
	...
	public static <T> T sendPostRequest(Path path, HashMap<String, String> uriParams,
			HashMap<String, String> queryParams, Object postBody, Class<T> tClass)
	 ...
	 * @throws Exception
	 */
	public static SubscribeSocket subscribeSocketConnect(String url, SubscribingCallback<?> callback)
			throws Exception {
	 ...
	 * @throws Exception
	 */
	public static SubscribeSysContractSocket subscribeSocketTransferConnect(String url,
			SubscribingCallback<?> callback) throws Exception {
		System.setProperty("org.eclipse.jetty.util.log.class", "org.eclipse.jetty.util.log.StdErrLog");
		System.setProperty("org.eclipse.jetty.LEVEL", "OFF");
		if (StringUtils.isBlank(url) || callback == null) {
			throw new ClientIOException("Invalid arguments ");
	...
	public static ContractCallResult callContract(ContractCall call, Address contractAddress, Revision revision)
		...
		return sendPostRequest(Path.PostContractCallPath, uriParams, queryParams, call,
				ContractCallResult.class);
	}
